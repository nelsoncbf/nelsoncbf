...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:3b47c9,100:00ADD8&height=180&section=header&text=Nelson%20Fonseca&fontSize=42&fontColor=fff&fontAlignY=38&desc=Backend%20Engineer%20%7C%20Cloud%20%7C%20Open%20Source&descAlignY=58&descSize=16" width="100%"/>

</div>

<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=16&pause=1000&color=3B47C9&center=true&vCenter=true&width=600&lines=Building+scalable+systems+at+Mambo+WiFi+%F0%9F%93%A1;Collaborating+on+RoadBR+%F0%9F%9B%A3%EF%B8%8F;Python+%7C+Go+%7C+JavaScript+%7C+PHP;AWS+%7C+GCP+%7C+Docker+%7C+Kubernetes)](https://git.io/typing-svg)
...
nelson = {
    ...
    "project":   "RoadBR 🛣️",
    "location":  "Brazil 🇧🇷",
    "languages": ["Python", "Go", "JavaScript", "PHP", "Bash"],
    "clouds":    ["AWS", "GCP", "Oracle Cloud", "Heroku", "Netlify"],
    "passion":   "Building things that scale — and that matter.",
    "pypi":      "ioannova",
}
```
...
| | |
|---|---|
| 🔭 **Building** | [Mambo WiFi](https://www.mambowifi.com) — hotspot & connectivity platform |
| 👯 **Collaborating** | [RoadBR](https://www.roadbr.com) — open source road data for Brazil |
| 📦 **Publishing** | Python packages on [PyPI](https://pypi.org/user/ioannova) as `ioannova` |
...
<details>
<summary><strong>Databases & Search</strong></summary>
<br>
...
<picture>
  ...
  <img alt="Snake animation" src="https://raw.githubusercontent.com/nelsoncbf/nelsoncbf/output/github-contribution-grid-snake.svg"/>
</picture>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00ADD8,100:3b47c9&height=100&section=footer" width="100%"/>
